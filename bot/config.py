...
SHOP_ENERGY_FULL_COST = 65
SHOP_WORK_LUCK_COST = 100
...
SHOP_BAIL_MIN = 40
SHOP_BAIL_MAX = 200
# Реформа крон — престиж-стоки
SHOP_TRIBUTE = 80
SHOP_TRIBUTE_WORK_BONUS = 0.05  # +5% работы
SHOP_TRIBUTE_HOURS = 2
SHOP_CRAFT_LICENSE = 70
SHOP_CRAFT_LICENSE_STACKS = 3  # на столько работ
SHOP_CRAFT_LICENSE_BONUS = 0.08  # +8% к работе
SHOP_HIRE_BLADE = 90
SHOP_HIRE_BLADE_BONUS = 0.08  # +8% шанс одного рейда

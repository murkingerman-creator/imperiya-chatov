...
GUIDE_PARTS = [
    ...
    (
        ...
        "💼 Работа — 7 занятий + конюшня + контрабанда. У каждой своя механика "
        "(подсечка, ритм кузни, уход за конём, риск шахты, торг…), ранги профессий.\n"
        ...
        "🎒 Сумка — продажа ×1 / все, «Слить хлам» (common/uncommon).\n"

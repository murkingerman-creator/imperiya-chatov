...
MENU_TEXT = (
    ...
    "• 🎒 Сумка · 🏪 Лавка (выкуп, колесо, баффы)\n"
...
GUIDE_PARTS = [
    ...
    (
        ...
        "💼 Работа — 7 занятий + контрабанда. У каждой своя механика "
        "(подсечка, ритм кузни, риск шахты, торг…), ранги профессий.\n"
        "  5 смен страны за час → 🐪 караван в казну.\n"
        ...
        "🏪 Лавка — выкуп из тюрьмы, эликсир, печать удачи, вклад в казну, "
        "знамя рейда, колесо удачи (казино: кд, уценка трофеев).\n"
